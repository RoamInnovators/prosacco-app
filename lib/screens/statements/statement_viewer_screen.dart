...
class _StatementViewerScreenState extends State<StatementViewerScreen> {
                ...
                pw.Row(
                  ...
                  children: [
                    pw.Column(
                      crossAxisAlignment: pw.CrossAxisAlignment.start,
                      children: [
                        pw.Text(result.saccoName, style: pw.TextStyle(fontSize: 22, fontWeight: pw.FontWeight.bold, color: white)),
                ...
                pw.Row(
                  ...
                  children: [
                    pw.Column(
                      crossAxisAlignment: pw.CrossAxisAlignment.start,
                      children: [
                pw.Text('This statement is system-generated by ${result.saccoName} Member Portal and is valid without a signature.', style: pw.TextStyle(fontSize: 9, color: muted)),
  ...
  Future<void> _downloadPdf() async {
    ...
    try {
      final bytes = await ProsaccoMemberAuthApi().downloadStatementPdf(
        token: widget.authToken,
        accountType: _result!.accountType,
        from: _fmt(_from),
        to: _fmt(_to),
      );
      await Printing.sharePdf(
        bytes: bytes,
        filename: '${(_result?.saccoName ?? 'Sacco').replaceAll(' ', '_')}_Statement_${widget.account.name.replaceAll(' ', '_')}_${_fmt(_from)}_${_fmt(_to)}.pdf',
      );
    } catch (e) {
      if (!mounted) return;
        ...
        children: [
                      ...
                      Row(
                        ...
                        children: [
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(result.saccoName, style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.w900, color: Colors.white, letterSpacing: -0.3)),
          ...
          Row(
            ...
            children: [
              Expanded(
                child: Text(
                  'This statement is system-generated by ${result.saccoName} Member Portal and is valid without a signature.',
